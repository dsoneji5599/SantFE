class SantProfileModel {
  ...
  factory SantProfileModel.fromJson(Map<String, dynamic> json) =>
      SantProfileModel(
  ...
  Map<String, dynamic> toJson() => {
    ...
    "diksha_date":
        "${dikshaDate!.year.toString().padLeft(4, '0')}-${dikshaDate!.month.toString().padLeft(2, '0')}-${dikshaDate!.day.toString().padLeft(2, '0')}",
